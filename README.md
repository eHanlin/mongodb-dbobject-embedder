...
libraryDependencies ++= Seq(
  "tw.com.ehanlin" % "mongodb-dbobject-embedder" % "0.0.2"
)
```
...
dependencies {
    compile 'tw.com.ehanlin:mongodb-dbobject-embedder:0.0.2'
}
```
...
@Grab('tw.com.ehanlin:mongodb-dbobject-embedder:0.0.2')
```
