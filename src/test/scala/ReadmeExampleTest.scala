...
abstract class ReadmeExampleTest extends Specification with BeforeAfterAll {
  ...
  def beforeAll(): Unit = {
    ...
    insert("game", "box_score",
      ...
      MObj("_id"->Oid("557e58727a8ea2a9dfe2ef8a"),"game"->Oid("557e58727a8ea2a9dfe2ef83"),"user"->Oid("557e58727a8ea2a9dfe2ef8a"),"pts"->NumInt(6),"ast"->NumInt(2)),
      MObj("_id"->Oid("557e58727a8ea2a9dfe2ef8b"),"game"->Oid("557e58727a8ea2a9dfe2ef83"),"user"->Oid("557e58727a8ea2a9dfe2ef8b"),"pts"->NumInt(6),"ast"->NumInt(5)),
      ...
      MObj("_id"->Oid("557e58727a8ea2a9dfe2ef8d"),"game"->Oid("557e58727a8ea2a9dfe2ef84"),"user"->Oid("557e58727a8ea2a9dfe2ef8a"),"pts"->NumInt(3),"ast"->NumInt(7)),
      MObj("_id"->Oid("557e58727a8ea2a9dfe2ef8e"),"game"->Oid("557e58727a8ea2a9dfe2ef84"),"user"->Oid("557e58727a8ea2a9dfe2ef8b"),"pts"->NumInt(15),"ast"->NumInt(2)),
